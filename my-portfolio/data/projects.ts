...
export const projects: Project[] = [
  {
    ...
    solution:
      "Automated system using soil sensors and weather API to regulate watering and sync data to the cloud.",
  ...
  },
  {
    ...
    solution:
      "Built a prototype using predictive models to monitor performance and trigger alerts before failures.",
  ...
  },
  {
    ...
    problem:
      "Traditional building monitoring lacks real-time fault detection, causing energy inefficiency.",
    solution:
      "Digital Twin system monitoring IoT sensor data in real time with ML-based anomaly detection.",
