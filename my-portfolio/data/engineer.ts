...
export const skills: Skill[] = [
  { id: "languages", category: "Languages", items: ["Python", "C/C++", "Java", "SQL", "JavaScript"] },
  {
    ...
    items: ["Arduino", "Raspberry Pi", "ESP32", "Node-RED", "Blynk IoT", "Tinkercad"],
  },
  {
    id: "cloud",
    category: "Cloud & Web",
    items: ["AWS", "Azure", "Firebase", "REST APIs", "HTML/CSS", "React"],
  },
...
export const positions: Position[] = [
  {
    ...
    description:
      "Leading the photography club, organizing shoots, workshops, and events across campus.",
  },
  {
    id: "co-organizer",
    title: "Co-Organizer",
    ...
    description:
      "Co-organized the college's flagship tech and cultural fest for three consecutive years.",
  },
  {
    id: "hackathon",
